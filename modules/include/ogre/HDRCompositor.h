...
#ifndef H_HDRCompositor_H
#define H_HDRCompositor_H
...
public:
	...
	static Ogre::String ToneMapperToString(const TONEMAPPER ToneMapper);
	static Ogre::String GlareTypeToString(const GLARETYPE GlareType);
	static Ogre::String StarTypeToString(const STARTYPE StarType);

private:

	void Create(void);

	void CreateTextureDef(const Ogre::String name,const unsigned int width,const unsigned int height,const Ogre::PixelFormat format);
