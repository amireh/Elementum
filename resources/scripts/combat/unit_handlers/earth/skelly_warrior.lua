local process = function(inUnit)
  inUnit:setMesh("Gremlin2.mesh")
  inUnit:setMaterial("Elementum/Gremlin/Skully")
  ...
  rnd:registerAnimationState(Pixy.Renderable.ANIM_DEATH1,  "Death_1", false)
  rnd:registerAnimationState(Pixy.Renderable.ANIM_DEATH2,  "Death_2", false)
  rnd:registerAnimationState(Pixy.Renderable.ANIM_ATTACK1, "Attack_1", false)
  rnd:registerAnimationState(Pixy.Renderable.ANIM_ATTACK2, "Attack_2", false)
...
subscribe_unit("Skelly Warrior", process)
